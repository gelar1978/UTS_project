...
import 'user1101194298.dart' as data1101194298;

class View1101194298 extends StatefulWidget {
  const View1101194298({super.key});
  @override
  State<View1101194298> createState() => _View1101194298State();
}

class _View1101194298State extends State<View1101194298> {
// data[]
  String _message = '';

// Map<int, String> Nama=Data.
  // TextEditingController _textEditingController0 = TextEditingController();
  List<int> NIM = data1101194298.index.values.toList();
  List<String> Nama = data1101194298.nama.values.toList();
  // @overrides
  @override
