...
class hal1101204132new extends StatelessWidget {
  const hal1101204132new({Key? key}) : super(key: key);
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => reset1101204132(),
                  ),
                );
                ...
                TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SignUpScreen1101204132(),
                      ),
                    );
                    //signup screen
                  },
