...
import 'user1101202505.dart' as data1101202505;

class View1101202505 extends StatefulWidget {
  const View1101202505({super.key});
  @override
  State<View1101202505> createState() => _View1101202505State();
}

class _View1101202505State extends State<View1101202505> {
// data[]
  String _message = '';

// Map<int, String> Nama=Data.
  // TextEditingController _textEditingController0 = TextEditingController();
  List<int> NIM = data1101202505.index.values.toList();
  List<String> Nama = data1101202505.nama.values.toList();
  // @overrides
  @override
