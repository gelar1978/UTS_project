...
import 'package:flutter_application_1/1101202505/nav1101202505.dart';
...
class hal1101202505new extends StatelessWidget {
  const hal1101202505new({Key? key}) : super(key: key);
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => reset1101202505(),
                  ),
                );
                ...
                TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SignUpScreen1101202505(),
                      ),
                    );
                    //signup screen
                  },
