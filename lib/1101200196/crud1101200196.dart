...
class crud1101200196 extends StatefulWidget {
  @override
  _crud1101200196State createState() => _crud1101200196State();
}

class _crud1101200196State extends State<crud1101200196> {
  final referenceDatabase =
      FirebaseDatabase.instance.reference().child('1101200196');
