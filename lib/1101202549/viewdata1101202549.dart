...
import 'user1101202549.dart' as data1101202549;

class View1101202549 extends StatefulWidget {
  const View1101202549({super.key});
  @override
  State<View1101202549> createState() => _View1101202549State();
}

class _View1101202549State extends State<View1101202549> {
// data[]
  String _message = '';

// Map<int, String> Nama=Data.
  // TextEditingController _textEditingController0 = TextEditingController();
  List<int> NIM = data1101202549.index.values.toList();
  List<String> Nama = data1101202549.nama.values.toList();
  // @overrides
  @override
