...
import 'package:flutter_application_1/1101204403/nav1101204403.dart';
import 'package:flutter_application_1/1101204403/reset1101204403.dart';
import 'package:flutter_application_1/1101204403/signup1101204403.dart';
...
class hal1101204403new extends StatelessWidget {
  const hal1101204403new({Key? key}) : super(key: key);
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => reset1101204403(),
                  ),
                );
                ...
                TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SignUpScreen1101204403(),
                      ),
                    );
                    //signup screen
                  },
