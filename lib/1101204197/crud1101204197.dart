...
void main() async {
  ...
  runApp(crud1101204197());
}

class crud1101204197 extends StatelessWidget {
  @override
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void createData() {
    databaseReference.child('1101204197').child('0001').set({
  ...
  void updateData() {
    databaseReference.child('1101204197').child('0001').update({
      'Nama': _nameController.text,
      'NIM': int.parse(_nimController.text),
      'Nilai': double.parse(_nilaiController.text),
      'Resume': _resumeController.text,
  ...
  void deleteData() {
    databaseReference.child('1101204197').child('0001').remove();
  }
      ...
      body: Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            // //     stream:
            // //         databaseReference.child('1101204197').child('0001').onValue,
