...
class crud1101204197 extends StatefulWidget {
  @override
  _crud1101204197State createState() => _crud1101204197State();
}

class _crud1101204197State extends State<crud1101204197> {
  final databaseReference = FirebaseDatabase.instance.ref('1101204197');
  List<Data> dataList = [];
