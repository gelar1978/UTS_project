...
class crud1101204173 extends StatefulWidget {
  @override
  _crud1101204173State createState() => _crud1101204173State();
}

class _crud1101204173State extends State<crud1101204173> {
  final databaseReference = FirebaseDatabase.instance.ref('1101204173');
  List<Data> dataList = [];
