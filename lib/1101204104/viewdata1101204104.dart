...
import 'user1101204104.dart' as data1101204104;

class View1101204104 extends StatefulWidget {
  const View1101204104({super.key});
  @override
  State<View1101204104> createState() => _View1101204104State();
}

class _View1101204104State extends State<View1101204104> {
// data[]
  String _message = '';

// Map<int, String> Nama=Data.
  // TextEditingController _textEditingController0 = TextEditingController();
  List<int> NIM = data1101204104.index.values.toList();
  List<String> Nama = data1101204104.nama.values.toList();
  // @overrides
  @override
