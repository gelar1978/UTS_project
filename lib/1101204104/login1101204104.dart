...
import 'package:flutter_application_1/1101204104/reset1101204104.dart';
import 'package:flutter_application_1/1101204104/signup1101204104.dart';
...
class hal1101204104new extends StatelessWidget {
  const hal1101204104new({Key? key}) : super(key: key);
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => reset1101204104(),
                  ),
                );
                ...
                TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SignUpScreen1101204104(),
                      ),
                    );
                    //signup screen
                  },
