...
class crud1101204104 extends StatefulWidget {
  @override
  _crud1101204104State createState() => _crud1101204104State();
}

class _crud1101204104State extends State<crud1101204104> {
  final databaseReference = FirebaseDatabase.instance.ref('1101204104');
  List<Data> dataList = [];
