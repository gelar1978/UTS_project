...
class hal1101204257old extends StatefulWidget {
  // final String message;
  hal1101204257old({super.key});

  @override
  State<hal1101204257old> createState() => _hal1101204257oldState();
}

class _hal1101204257oldState extends State<hal1101204257old> {
                              ...
                              onPressed: () async {
                                if (_textEditingController.text ==
                                  ...
                                  final result = await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => hal1101204257old_2(
...
class hal1101204257old_2 extends StatefulWidget {
  // hal1101204257old_2({super.key,required this.pesan1});
  String pesan1 = '';
  hal1101204257old_2({super.key, required this.pesan1});
  @override
  _hal1101204257old_2State createState() => _hal1101204257old_2State();
}

class _hal1101204257old_2State extends State<hal1101204257old_2> {
  String NIM7 = '';
                              ...
                              onPressed: () async {
                                if (_textEditingController2.text ==
                                  ...
                                  final result = await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => hal1101204257old_3(
                                        pesan1: NIM7,
...
class hal1101204257old_3 extends StatefulWidget {
  String pesan1 = '';
  String pesan2 = '';
  String pesan3 = '';
  hal1101204257old_3(
  ...
  @override
  _hal1101204257old_3State createState() => _hal1101204257old_3State();
}

class _hal1101204257old_3State extends State<hal1101204257old_3> {
  String NIM10 = '';
  String TLP = '';
                              ...
                              onPressed: () async {
                                if (_textEditingController3.text == '57') {
                                  ...
                                  final result = await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => hal1101204257old_4(
                                        pesan1: NIM10,
                                        pesan2: TLP,
...
class hal1101204257old_4 extends StatefulWidget {
  // hal1101204257old_2({super.key,required this.pesan1});
  String pesan1 = '';
  String pesan2 = '';
  String pesan3 = '';
  hal1101204257old_4(
      ...
      required this.pesan3});
  @override
  _hal1101204257old_4State createState() => _hal1101204257old_4State();
}

class _hal1101204257old_4State extends State<hal1101204257old_4> {
  //
  @override
  Widget build(BuildContext context) {
