...
import 'user1101190144.dart' as data1101190144;

class View1101190144 extends StatefulWidget {
  const View1101190144({super.key});
  @override
  State<View1101190144> createState() => _View1101190144State();
}

class _View1101190144State extends State<View1101190144> {
// data[]
  String _message = '';

// Map<int, String> Nama=Data.
  // TextEditingController _textEditingController0 = TextEditingController();
  List<int> NIM = data1101190144.index.values.toList();
  List<String> Nama = data1101190144.nama.values.toList();
  // @overrides
  @override
