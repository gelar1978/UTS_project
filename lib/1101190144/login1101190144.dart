...
import 'reset1101190144.dart';
import 'signup1101190144.dart';
// import 'package:flutter_signin_button/flutter_signin_button.dart';
// import 'package:sign_button/sign_button.dart'
// void main() => runApp(const MyApp());

class hal1101190144new extends StatelessWidget {
  const hal1101190144new({Key? key}) : super(key: key);
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => reset1101190144(),
                  ),
                );
                ...
                TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SignUpScreen1101190144(),
                      ),
                    );
                    //signup screen
                  },
