...
class crud1101190144 extends StatefulWidget {
  @override
  _crud1101190144State createState() => _crud1101190144State();
}

class _crud1101190144State extends State<crud1101190144> {
  ...
  void initState() {
    ...
    databaseReference.once().then((snapshot) {
      setState(() {
        dataList.clear();
        ReadWriteValue<DatabaseEvent> values = snapshot.val('1101190144');
